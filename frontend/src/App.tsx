    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h1 style={{ margin: 0, fontSize: '32px' }}>🍕 ChefOps Cloud Kitchen</h1>
        ...
        {!loading && !error && menuItems.length > 0 && (
          <>
            <div style={{
              ...
              💡 <strong>Admin Tip:</strong> Click on any menu item to update its price, availability, or special status
            </div>
